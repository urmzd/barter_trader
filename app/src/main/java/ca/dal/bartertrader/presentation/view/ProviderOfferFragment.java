...
public class ProviderOfferFragment extends Fragment implements OfferListener {
    ...
    public void onReviewClick(OfferModel offerModel) {
        ProviderOfferFragmentDirections.ActionProviderOfferFragmentToHandleReviewFragment
                action = ProviderOfferFragmentDirections.actionProviderOfferFragmentToHandleReviewFragment(offerModel);
